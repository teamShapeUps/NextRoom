...
import { makeStyles, Button, Collapse, TextField, Typography } from '@material-ui/core';
        ...
        <div className={classes.container}>
            ...
            <Collapse in={addingNewBath}>
                <div className={classes.newBathForm}>
                    <TextField label ="Title" onChange={(e)=>setNewBathTitle(e.target.value)}/>
                    <TextField label ="Description" multiline onChange={(e)=>setNewBathDescription(e.target.value)}/>
                    <TextField label="$$$ / 10mins" onChange={(e)=>setNewBathPrice(e.target.value)}/>
                    <TextField label="Bathroom's Street, City, and State" onChange={(e)=>setNewBathAddress(e.target.value)}/>
                    <TextField label="Bathroom's Zip Code" onChange={(e)=>setNewBathZip(e.target.value)}/>
                    <TextField label="Image URL" onChange={(e)=>setNewBathImg(e.target.value)}/>
                    <Button className={classes.addButton} onClick={addBathroomHandler}>Get this Potty Started!</Button>
                    <Button className={classes.cancelButton} onClick={()=>{setAddingNewBath(!addingNewBath)}}>Nah, it's not Potty time yet</Button>
                </div>
            </Collapse>
