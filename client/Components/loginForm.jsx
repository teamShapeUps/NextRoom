...
import {
  Button, Box, TextField, Collapse, Switch, Typography,
      ...
      <div className={classes.div}>
        ...
        <Box className={classes.box}>
          ...
          <Collapse in={checked} orientation="horizontal">
            <br />
            <br />
            <TextField placeholder="username" onChange={(e) => setCreateUsername(e.target.value)} />
            <br />
            <br />
            <TextField placeholder="password" onChange={(e) => setCreatePassword(e.target.value)} />
            <br />
            <br />
            <Button
              className={classes.button}
