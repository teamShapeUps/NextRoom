...
app.post("/addbathroom", bathroomController.addBathroom, (req, res) =>
...
app.delete("/deleteBathroom", bathroomController.deleteBathroom, (req, res) => {
  res.status(200).json("bathroom deleted");
});

app.get("/getbathrooms", bathroomController.getHostBathrooms, (req, res) => {
...
app.post("/updatebathroom", bathroomController.updateBathroom, (req, res) => {
...
app.get("/usersappointments", getReservations, (req, res) => {
